...
public class ReportWithOverflowTextAndBrokenImagesTest {
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void testReport(String date, String auditor, String plads, String miljopolitik_comment, String miljopolitik_status, String miljo_plan_comment, String miljo_plan_status, String validImage, String wrongImage) {
        try {
