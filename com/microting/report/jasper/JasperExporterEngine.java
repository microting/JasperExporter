...
public class JasperExporterEngine
{
    ...
    protected JasperReport loadTemplate(String templateFile)
            throws JRException
    {
        if ((templateFile != null) && (!"".equals(templateFile))) { if (FilenameUtils.isExtension(templateFile, new String[] { "jrxml", "jasper" })) {}
    ...
    protected JasperReport compileTemplateAndDependencies(String templateFile)
            throws JRException
    {
        ...
        for (JRExpression expr : JRExpressionCollector.collectExpressions(design)) {
